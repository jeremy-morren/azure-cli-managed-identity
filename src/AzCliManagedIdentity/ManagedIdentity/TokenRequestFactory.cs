...
public static class TokenRequestFactory
{
    ...
    /// <summary>
    /// Request path for token requests from MSI_ENDPOINT.
    /// This is referred to as 'Azure Cloud Shell' in the Azure.Identity library.
    /// </summary>
    public const string CloudShellRequestPath = "/token";
    ...
    /// </remarks>
    public static bool TryCreateCloudShellRequest(
        HttpRequest request,
